...
la("WeakMap",function(a){function b(g){this.b=(h+=Math.random()+1).toString();if(g){g=ba(g);for(var l;!(l=g.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
function d(g){ta(g,f)||ja(g,f,{value:new c})}
function e(g){var l=Object[g];l&&(Object[g]=function(k){if(k instanceof c)return k;d(k);return l(k)})}
if(function(){if(!a||!Object.seal)return!1;try{var g=Object.seal({}),l=Object.seal({}),k=new a([[g,2],[l,3]]);if(2!=k.get(g)||3!=k.get(l))return!1;k["delete"](g);k.set(l,4);return!k.has(g)&&4==k.get(l)}catch(q){return!1}}())return a;
var f="$jscomp_hidden_"+Math.random();e("freeze");e("preventExtensions");e("seal");var h=0;b.prototype.set=function(g,l){d(g);if(!ta(g,f))throw Error("WeakMap key fail: "+g);g[f][this.b]=l;return this};
...
function c(g,l){var k=g.b;return sa(function(){if(k){for(;k.head!=g.b;)k=k.previous;for(;k.next!=k.head;)return k=k.next,{done:!1,value:l(k)};k=null}return{done:!0,value:void 0}})}
function d(g,l){var k=l&&typeof l;"object"==k||"function"==k?f.has(l)?k=f.get(l):(k=""+ ++h,f.set(l,k)):k="p_"+l;var q=g.f[k];if(q&&ta(g.f,k))for(var t=0;t<q.length;t++){var w=q[t];if(l!==l&&w.key!==w.key||l===w.key)return{id:k,list:q,index:t,o:w}}return{id:k,list:q,index:-1,o:void 0}}
function e(g){this.f={};this.b=b();this.size=0;if(g){g=ba(g);for(var l;!(l=g.next()).done;)l=l.value,this.set(l[0],l[1])}}
if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var g=Object.seal({x:4}),l=new a(ba([[g,"s"]]));if("s"!=l.get(g)||1!=l.size||l.get({x:4})||l.set({x:4},"t")!=l||2!=l.size)return!1;var k=l.entries(),q=k.next();if(q.done||q.value[0]!=g||"s"!=q.value[1])return!1;q=k.next();return q.done||4!=q.value[0].x||"t"!=q.value[1]||!k.next().done?!1:!0}catch(t){return!1}}())return a;
ra();var f=new WeakMap;e.prototype.set=function(g,l){g=0===g?0:g;var k=d(this,g);k.list||(k.list=this.f[k.id]=[]);k.o?k.o.value=l:(k.o={next:this.b,previous:this.b.previous,head:this.b,key:g,value:l},k.list.push(k.o),this.b.previous.next=k.o,this.b.previous=k.o,this.size++);return this};
...
e.prototype.forEach=function(g,l){for(var k=this.entries(),q;!(q=k.next()).done;)q=q.value,g.call(l,q[1],q[0],this)};
...
var Ob={};function H(){this.b="";this.f=Qb}
H.prototype.J=!0;H.prototype.I=function(){return this.b.toString()};
H.prototype.aa=!0;H.prototype.X=function(){return 1};
function Rb(a){if(a instanceof H&&a.constructor===H&&a.f===Qb)return a.b;za(a);return"type_error:SafeUrl"}
var Sb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function Tb(a){if(a instanceof H)return a;a="object"==typeof a&&a.J?a.I():String(a);Sb.test(a)||(a="about:invalid#zClosurez");return Ub(a)}
var Qb={};function Ub(a){var b=new H;b.b=a;return b}
...
Xb("<!DOCTYPE html>",0);Xb("",0);Xb("<br>",0);function Yb(a,b){var c=b instanceof H?b:Tb(b);a.href=Rb(c)}
...
;function sc(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;q=k=0}
function b(t){for(var w=h,p=0;64>p;p+=4)w[p/4]=t[p]<<24|t[p+1]<<16|t[p+2]<<8|t[p+3];for(p=16;80>p;p++)t=w[p-3]^w[p-8]^w[p-14]^w[p-16],w[p]=(t<<1|t>>>31)&4294967295;t=e[0];var G=e[1],V=e[2],na=e[3],tc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ka=na^G&(V^na);var Cb=1518500249}else Ka=G^V^na,Cb=1859775393;else 60>p?(Ka=G&V|na&(G|V),Cb=2400959708):(Ka=G^V^na,Cb=3395469782);Ka=((t<<5|t>>>27)&4294967295)+Ka+tc+Cb+w[p]&4294967295;tc=na;na=V;V=(G<<30|G>>>2)&4294967295;G=t;t=Ka}e[0]=e[0]+t&4294967295;e[1]=
e[1]+G&4294967295;e[2]=e[2]+V&4294967295;e[3]=e[3]+na&4294967295;e[4]=e[4]+tc&4294967295}
function c(t,w){if("string"===typeof t){t=unescape(encodeURIComponent(t));for(var p=[],G=0,V=t.length;G<V;++G)p.push(t.charCodeAt(G));t=p}w||(w=t.length);p=0;if(0==k)for(;p+64<w;)b(t.slice(p,p+64)),p+=64,q+=64;for(;p<w;)if(f[k++]=t[p++],q++,64==k)for(k=0,b(f);p+64<w;)b(t.slice(p,p+64)),p+=64,q+=64}
function d(){var t=[],w=8*q;56>k?c(g,56-k):c(g,64-(k-56));for(var p=63;56<=p;p--)f[p]=w&255,w>>>=8;b(f);for(p=w=0;5>p;p++)for(var G=24;0<=G;G-=8)t[w++]=e[p]>>G&255;return t}
for(var e=[],f=[],h=[],g=[128],l=1;64>l;++l)g[l]=0;var k,q;a();return{reset:a,update:c,digest:d,qa:function(){for(var t=d(),w="",p=0;p<t.length;p++)w+="0123456789ABCDEF".charAt(Math.floor(t[p]/16))+"0123456789ABCDEF".charAt(t[p]%16);return w}}}
...
var Ac;
function Bc(){var a=r.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!F("Presto")&&(a=function(){var e=document.createElement("IFRAME");e.style.display="none";e.src="";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write("");e.close();var h="callImmediate"+Math.random(),g="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=z(function(l){if(("*"==g||l.origin==g)&&l.data==
...
function Nc(a,b,c){c||(c=0);var d=a.u;if(v(b))for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.b[0];c=a.b[1];var h=a.b[2],g=a.b[3],l=a.b[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=g^c&(h^g);var k=1518500249}else f=c^h^g,k=1859775393;else 60>e?(f=c&h|g&(c|h),k=2400959708):(f=c^h^g,k=
3395469782);f=(b<<5|b>>>27)+f+l+k+d[e]&4294967295;l=g;g=h;h=(c<<30|c>>>2)&4294967295;c=b;b=f}a.b[0]=a.b[0]+b&4294967295;a.b[1]=a.b[1]+c&4294967295;a.b[2]=a.b[2]+h&4294967295;a.b[3]=a.b[3]+g&4294967295;a.b[4]=a.b[4]+l&4294967295}
...
function od(a,b,c,d){var e=md(null,null,null);e.b=new J(function(f,h){e.f=b?function(g){try{var l=b.call(d,g);f(l)}catch(k){h(k)}}:f;
e.onRejected=c?function(g){try{var l=c.call(d,g);!u(l)&&g instanceof qd?h(g):f(l)}catch(k){h(k)}}:h});
e.b.g=a;ud(a,e);return e.b}
J.prototype.w=function(a){this.b=0;jd(this,2,a)};
J.prototype.B=function(a){this.b=0;jd(this,3,a)};
function jd(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;a:{var d=c,e=a.w,f=a.B;if(d instanceof J){ud(d,md(e||xa,f||null,a));var h=!0}else if(id(d))d.then(e,f,a),h=!0;else{if(Da(d))try{var g=d.then;if(Ca(g)){wd(d,g,e,f,a);h=!0;break a}}catch(l){f.call(a,l);h=!0;break a}h=!1}}h||(a.u=c,a.b=b,a.g=null,vd(a),3!=b||c instanceof qd||xd(a,c))}}
function wd(a,b,c,d,e){function f(l){g||(g=!0,d.call(e,l))}
function h(l){g||(g=!0,c.call(e,l))}
var g=!1;try{b.call(a,h,f)}catch(l){f(l)}}
...
return b.join("&")}
function je(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),h=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Aa(b[f])?Sa(b[f],h):b[f]=[b[f],h]:b[f]=h}catch(l){var g=Error("Error decoding URL component");g.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?ge(g):Q(g)}}return b}
...
function ne(a){var b=a.b;try{var c=b.screenX;var d=b.screenY}catch(t){}try{var e=b.outerWidth;var f=b.outerHeight}catch(t){}try{var h=b.innerWidth;var g=b.innerHeight}catch(t){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,h,g];c=a.b.top;try{var l=(c||window).document,k="CSS1Compat"==l.compatMode?l.documentElement:l.body;var q=(new ac(k.clientWidth,k.clientHeight)).round()}catch(t){q=new ac(-12245933,-12245933)}l=q;q={};k=new Xd;r.SVGElement&&
r.document.createElementNS&&k.set(0);c=oc();c["allow-top-navigation-by-user-activation"]&&k.set(1);c["allow-popups-to-escape-sandbox"]&&k.set(2);r.crypto&&r.crypto.subtle&&k.set(3);k=Yd(k);q.bc=k;q.bih=l.height;q.biw=l.width;q.brdim=b.join();a=a.f;return q.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,q.wgl=!!C.WebGLRenderingContext,q}
...
function ye(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=ze(a,b);var d=Ae(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(h){if(!e){e=!0;f&&T(f);var g=h.ok,l=function(k){k=k||{};var q=b.context||r;g?b.onSuccess&&b.onSuccess.call(q,k,h):b.onError&&b.onError.call(q,k,h);b.ca&&b.ca.call(q,k,h)};
"JSON"==(b.format||"JSON")&&(g||400<=h.status&&500>h.status)?h.json().then(l,function(){l(null)}):l(null)}});
b.ga&&0<b.timeout&&(f=S(function(){e||(e=!0,T(f),b.ga.call(b.context||r))},b.timeout))}else Be(a,b)}
function Be(a,b){var c=b.format||"JSON";a=ze(a,b);var d=Ae(a,b),e=!1,f,h=Ce(a,function(g){if(!e){e=!0;f&&T(f);var l=re(g),k=null,q=400<=g.status&&500>g.status,t=500<=g.status&&600>g.status;if(l||q||t)k=De(c,g,b.lb);if(l)a:if(g&&204==g.status)l=!0;else{switch(c){case "XML":l=0==parseInt(k&&k.return_code,10);break a;case "RAW":l=!0;break a}l=!!k}k=k||{};q=b.context||r;l?b.onSuccess&&b.onSuccess.call(q,g,k):b.onError&&b.onError.call(q,g,k);b.ca&&b.ca.call(q,g,k)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
...
function Ce(a,b,c,d,e,f,h){function g(){4==(l&&"readyState"in l?l.readyState:0)&&b&&fe(b)(l)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var l=qe();if(!l)return null;"onloadend"in l?l.addEventListener("loadend",g,!1):l.onreadystatechange=g;R("debug_forward_web_query_parameters")&&(a=xe(a));l.open(c,a,!0);f&&(l.responseType=f);h&&(l.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=ve(a,e))for(var k in e)l.setRequestHeader(k,e[k]),"content-type"==k.toLowerCase()&&(c=!1);c&&l.setRequestHeader("Content-Type","application/x-www-form-urlencoded");l.send(d);
return l}
;var Ie={},Je=0;
function Ke(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=db,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.J?a.I():String(a),Sb.test(a)||(a="about:invalid#zClosurez"),a=Ub(a)),b=Rb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Vb?a=b:(d="object"==typeof b,a=null,d&&b.aa&&(a=b.X()),b=Ua(d&&b.J?b.I():String(b)),a=Xb(b,a)),a instanceof Vb&&a.constructor===Vb&&a.g===Wb?a=a.b:(za(a),a="type_error:SafeHtml"),a=encodeURIComponent(String(cd(a.toString())))),/^[\s\xa0]*$/.test(a)||
...
c.src=a}
;var Ne={},Oe=0;
function Pe(a,b,c,d,e,f){f=f||{};f.name=c||P("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||P("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(!(!a||!e||5<=Oe||(e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Jb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),
Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Ua:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},C:{url:P("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);e&&(b.C.stack=e);for(var h in f)b.C["client."+h]=f[h];if(h=P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var g in h)b.C[g]=h[g];Be(P("ECATCHER_REPORT_HOST","")+"/error_204",b);Ne[a.message]=
!0;Oe++}}
...
function U(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Nf(a,b,c,d);if(e)return e;e=++Mf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var h=f?function(g){g=new Kf(g);if(!hc(g.relatedTarget,function(l){return l==a}))return g.currentTarget=a,g.type=b,c.call(a,g)}:function(g){g=new Kf(g);
...
function hg(a,b){var c=Zf[a],d=fg[a]||{};fg[a]=d;var e=Math.round(N());for(k in W[a]){var f=ob,h=b.b;h={client:{hl:h.Ca,gl:h.Ba,clientName:h.za,clientVersion:h.Aa}};var g=window.devicePixelRatio;g&&1!=g&&(h.client.screenDensityFloat=String(g));P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(h.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:h});f[c]=jg(a,k);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(h=eg[k])a:{var l=k;if(h.videoId)g=
"VIDEO";else if(h.playlistId)g="PLAYLIST";else break a;f.credentialTransferTokenTargetId=h;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:l,scope:g}]}delete eg[k];f.requestTimeMs=e;if(h=ae("EVENT_ID"))g=(P("BATCH_CLIENT_COUNTER",void 0)||0)+1,g>Wf&&(g=1),O("BATCH_CLIENT_COUNTER",g),h={serializedEventId:h,clientCounter:g},f.serializedClientEventId=h,Xf&&Yf&&R("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:Xf,roundtripMs:Yf}),
Xf=h,Yf=0;kg(b,a,f,{retry:ag.has(a),onSuccess:z(lg,this,N())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var k=d.diffCount||0;d.averageTimeBetweenDispatchesMs=k?(d.averageTimeBetweenDispatchesMs*k+c)/(k+1):c;d.diffCount=k+1}d.previousDispatchMs=e}
...
function og(a){a=Object.assign({},a);delete a.Authorization;var b=wc();if(b){var c=new Mc;c.update(P("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();Ba(b);if(!Fb)for(Fb={},Gb={},c=0;65>c;c++)Fb[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c),Gb[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c);c=Gb;for(var d=[],e=0;e<b.length;e+=3){var f=b[e],h=e+1<b.length,g=h?b[e+1]:0,l=e+2<b.length,k=l?b[e+2]:0,q=f>>2;f=(f&3)<<4|g>>4;g=(g&15)<<
2|k>>6;k&=63;l||(k=64,h||(g=64));d.push(c[q],c[f],c[g],c[k])}a.hash=d.join("")}return a}
...
timeout:d.timeout,withCredentials:!0},f="",h=a.b.Da;h&&(f=h);h=a.b.Ea||!1;var g=ng(h,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var l=""+f+("/youtubei/"+a.b.ya+"/"+b)+"?alt=json&key="+a.b.xa,k;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(k=sg(b,c,g,h))){var q=e.onSuccess,t=e.fa;e.onSuccess=function(w,p){tg(k);q(w,p)};
c.fa=function(w,p){tg(k);t(w,p)}}try{R("use_fetch_for_op_xhr")?ye(l,e):He(l,e)}catch(w){if("InvalidAccessError"==w)k&&(tg(k),k=0),Q(Error("An extension is blocking network request."),"WARNING");
else throw w;}k&&rf(function(){ug(a)},0,5E3)}
;var wg=A().toString();
...
parseInt(g,10);isFinite(g)&&0<g&&(d="ST-"+cb(d).toString(36),b=b?Td(b):"",pg(d,b,g||5))}else g="ST-"+cb(d).toString(36),b=b?Td(b):"",pg(g,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var k=void 0===k?"":k;var q=void 0===q?window:q;c=q.location;a=Ud(a,l)+k;a=a instanceof H?a:Tb(a);c.href=Rb(a)}return!0}
...
function Lh(){rh();if(!Gh()){var a=Jh(),b=Eh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in wh){var e=Na(a[f],function(k){return Math.round(k-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Dh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+y("ytplayer.config.assets.js");(h=X.getEntriesByName?X.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):delete b.h5jse}a.aft=Ih();Kh()&&"youtube"==e&&(Dh(),e=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-e));for(var g in b)"_"!=g.charAt(0)&&(f[g]=b[g]);a.ps=N();g={};e=[];for(var l in a)"_"!=
l.charAt(0)&&(h=Math.round(a[l]-c),g[l]=h,e.push(l+"."+h));f.rt=e.join(",");(a=y("ytdebug.logTiming"))&&a(f,g);Mh(f,!!b.ap);ph(vh,new th(g.aft+(d||0),void 0))}}
...
m.Z=function(){if(!this.b)return null;var a=this.b.getApiInterface();Qa(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c],f=e;if(0==f.search("get")||0==f.search("is")){f=e;var h=0;0==f.search("get")?h=3:0==f.search("is")&&(h=2);f=f.charAt(h).toLowerCase()+f.substr(h+1);try{var g=this.b[e]();b[f]=g}catch(l){}}}b.videoData=this.b.getVideoData();b.currentTimeLastUpdated_=A()/1E3;return b};
...
m.Ma=function(){for(var a=this.b.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.b.getOptions(e);b[e]={options:f};for(var h=0,g=f.length;h<g;h++){var l=f[h],k=this.b.getOption(e,l);b[e][l]=k}}this.sendMessage("apiInfoDelivery",b)};
...
;function si(a){if("1"!==hb(be(),"args","privembed")){a&&ce();try{ri().then(function(b){b=ie(b);b.bsq=ti++;He("//www.youtube.com/ad_data_204",{va:!1,C:b,withCredentials:!0})},function(){}),S(si,18E5)}catch(b){Q(b)}}}
